...
`;
    ...
    var ld=document.createElement("div");ld.id="custom-loader";ld.style.cssText="position:fixed;top:0;left:0;width:100%;height:100%;background:#000 url('game_assets/loading.png') center center no-repeat;background-size:contain;z-index:9999;";document.body.appendChild(ld);
...
, function(n, e) {
    ...
    window.rewardedBreak = function() {
        ...
        (n = PokiSDK).rewardedBreak.apply(n, arguments).then(function(n) {
            window.unityGame.SendMessage(t, "rewardedBreakCompleted", n.toString())
        })
    }
    ,
    window.shareableURL = function(n) {
        PokiSDK.shareableURL(n).then(function(n) {
